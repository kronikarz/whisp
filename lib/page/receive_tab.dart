...
class _ReceiveTabState extends State<ReceiveTab> with AutomaticKeepAliveClientMixin, TickerProviderStateMixin {
                            ...
                            child: Opacity(
                              ...
                              child: FittedBox(
                                ...
                                child: SettingsButton(
                                  ...
                                  onPressed: state is ReceiveTabEmptyState ? () => _showDeviceSelectionDialog(context, audioDevices) : null,
                                ),
                              ),
                            ),
                          ),
  ...
  void _showDeviceSelectionDialog(BuildContext context, List<AudioDevice> inputDevices) {
    showDialog(
      context: context,
      barrierDismissible: false,
      builder: (BuildContext context) => AlertDialog(
        title: Text(
          audioDevices.isEmpty ? 'No microphone detected - plug audio input device' : 'Select input device',
